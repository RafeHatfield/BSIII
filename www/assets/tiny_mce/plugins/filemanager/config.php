<?php
	...
	$mcFileManagerConfig['filesystem.rootpath'] = '../../../../uploads/ufiles'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,xls,xlsx,doc,docx,ppt,pptx";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,xls,xlsx,doc,docx,ppt,pptx";
	...
	$mcFileManagerConfig['download.extensions'] = "htm,html,gif,jpg,png,pdf,zip,xls,xlsx,ppt,doc,docx,pptx";
	...
	$mcFileManagerConfig['ExternalAuthenticator.external_auth_url'] = "/scripts/tiny_mce/auth.cfm";
