<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../uploads/ufiles'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['ExternalAuthenticator.external_auth_url'] = "/scripts/tiny_mce/auth.cfm";
