...
<cfset myFusebox.thisFuseaction = "profileList">
<cfset xfa.saveProfile = "system.profileList" />
<cfset xfa.editProfile = "system.profileList" />
<cfset xfa.permissionsList = "system.profilePermissions" />
<cfif not isDefined("attributes.prf_id")><cfset attributes.prf_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<!--- do action="m_system.profileAction" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.profileAction""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "profileAction">
<cfset myFusebox.trace("Runtime","&lt;include template=""act_profileAction.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/act_profileAction.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 21 and right(cfcatch.MissingFileName,21) is "act_profileAction.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_profileAction.cfm in circuit m_system which does not exist (from fuseaction m_system.profileAction).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "system">
<cfset myFusebox.thisFuseaction = "profileList">
</cfif>
<!--- do action="m_system.getProfile" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.getProfile""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "getProfile">
<cfset myFusebox.trace("Runtime","&lt;include template=""qry_getProfile.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/qry_getProfile.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 18 and right(cfcatch.MissingFileName,18) is "qry_getProfile.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getProfile.cfm in circuit m_system which does not exist (from fuseaction m_system.getProfile).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "system">
<cfset myFusebox.thisFuseaction = "profileList">
<cfif getProfile.recordCount gte 1>
<cfset attributes.prf_name = "#getProfile.prf_name#" />
<cfset attributes.prf_description = "#getProfile.prf_description#" />
<cfelse>
<cfset attributes.prf_name = "" />
<cfset attributes.prf_description = "" />
</cfif>
<!--- do action="v_system.profileForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_system.profileForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_system">
<cfset myFusebox.thisFuseaction = "profileForm">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_profileForm.cfm"" circuit=""v_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/view/dsp_profileForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "dsp_profileForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_profileForm.cfm in circuit v_system which does not exist (from fuseaction v_system.profileForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<!--- do action="m_system.getProfiles" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.getProfiles""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "getProfiles">
<cfset myFusebox.trace("Runtime","&lt;include template=""qry_getProfiles.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/qry_getProfiles.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "qry_getProfiles.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getProfiles.cfm in circuit m_system which does not exist (from fuseaction m_system.getProfiles).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="v_system.profileList" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_system.profileList""/&gt;") >
<cfset myFusebox.thisCircuit = "v_system">
<cfset myFusebox.thisFuseaction = "profileList">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_profileList.cfm"" circuit=""v_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/view/dsp_profileList.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "dsp_profileList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_profileList.cfm in circuit v_system which does not exist (from fuseaction v_system.profileList).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
