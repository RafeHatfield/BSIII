...
<cfset myFusebox.thisFuseaction = "newsletterView">
<cfif not isDefined("attributes.nsl_id")><cfset attributes.nsl_id = "0" /></cfif>
<cfset attributes.displayMode = "print" />
<cfset newsletterBody = application.contentObj.displayNewsletter(attributes.nsl_id) >
<cfif not isDefined("content.mainContent")><cfset content.mainContent = "#newsletterBody#" /></cfif>
