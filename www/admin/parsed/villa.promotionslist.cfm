...
<cfset myFusebox.thisCircuit = "villa">
<cfset myFusebox.thisFuseaction = "promotionsList">
<cfset xfa.savePromotion = "villa.promotionsList" />
<cfset xfa.editPromotion = "villa.promotionForm" />
<cfif not isDefined("attributes.prm_id")><cfset attributes.prm_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.villaObj.promotionSave(argumentCollection=attributes) >
</cfif>
<cfset qPromotion = application.villaObj.getPromotion(prm_id=attributes.prm_id) >
<cfif qPromotion.recordCount gte 1>
<cfset attributes.prm_title = "#qPromotion.prm_title#" />
<cfset attributes.prm_body = "#qPromotion.prm_body#" />
<cfset attributes.prm_active = "#qPromotion.prm_active#" />
<cfelse>
<cfset attributes.prm_title = "" />
<cfset attributes.prm_body = "" />
<cfset attributes.prm_active = "" />
</cfif>
<!--- do action="v_villa.promotionForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_villa.promotionForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_villa">
<cfset myFusebox.thisFuseaction = "promotionForm">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_promotionForm.cfm"" circuit=""v_villa""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../villa/view/dsp_promotionForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 21 and right(cfcatch.MissingFileName,21) is "dsp_promotionForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_promotionForm.cfm in circuit v_villa which does not exist (from fuseaction v_villa.promotionForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<cfset myFusebox.thisCircuit = "villa">
<cfset myFusebox.thisFuseaction = "promotionsList">
<cfset qPromotions = application.villaObj.getPromotionsAdmin() >
<!--- do action="v_villa.promotionsList" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_villa.promotionsList""/&gt;") >
<cfset myFusebox.thisCircuit = "v_villa">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_promotionsList.cfm"" circuit=""v_villa""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../villa/view/dsp_promotionsList.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 22 and right(cfcatch.MissingFileName,22) is "dsp_promotionsList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_promotionsList.cfm in circuit v_villa which does not exist (from fuseaction v_villa.promotionsList).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
