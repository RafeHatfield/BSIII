...
<cfset myFusebox.thisFuseaction = "gloryBoxList">
<cfif not isDefined("attributes.gbx_id")><cfset attributes.gbx_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.contentObj.gloryBoxSave(argumentCollection=attributes) >
<cfset attributes.gbx_id = "0" />
</cfif>
<cfset gloryBoxForm = application.contentObj.displayGloryBoxForm(attributes.gbx_id) >
<cfset gloryBoxList = application.contentObj.displayGloryBoxList() >
<cfset content.mainContent = "#gloryBoxForm##gloryBoxList#" />
