...
<cfset myFusebox.thisFuseaction = "memberMessages">
<cfif not isDefined("attributes.mem_id")><cfset attributes.mem_id = "0" /></cfif>
<cfset qMemberMessages = application.memberObj.getMemberMessages(mem_id=attributes.mem_id) >
<!--- do action="v_member.memberMessages" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_member.memberMessages""/&gt;") >
<cfset myFusebox.thisCircuit = "v_member">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_memberMessages.cfm"" circuit=""v_member""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../member/view/dsp_memberMessages.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 22 and right(cfcatch.MissingFileName,22) is "dsp_memberMessages.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_memberMessages.cfm in circuit v_member which does not exist (from fuseaction v_member.memberMessages).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
