...
<cfset myFusebox.thisFuseaction = "galleryImagesForm">
<cfset xfa.saveGalleryImages = "web.galleryImagesForm" />
<cfif not isDefined("attributes.gal_id")><cfset attributes.gal_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.imageObj.galleryImagesSave(argumentCollection=attributes) >
</cfif>
<cfset qGalleryImages = application.imageObj.getGalleryImages(gal_id=attributes.gal_id) >
<!--- do action="v_web.galleryImagesForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_web.galleryImagesForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_web">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_galleryImagesForm.cfm"" circuit=""v_web""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../web/view/dsp_galleryImagesForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 25 and right(cfcatch.MissingFileName,25) is "dsp_galleryImagesForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_galleryImagesForm.cfm in circuit v_web which does not exist (from fuseaction v_web.galleryImagesForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
