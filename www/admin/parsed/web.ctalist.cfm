...
<cfset myFusebox.thisFuseaction = "ctaList">
<cfif not isDefined("attributes.cta_id")><cfset attributes.cta_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.ctaObj.ctaSave(argumentCollection=attributes) >
</cfif>
<cfset ctaForm = application.ctaObj.displayCTAForm(cta_id=attributes.cta_id) >
<cfset ctaList = application.ctaObj.displayCTAList(cta_id=attributes.cta_id) >
<cfset content.mainContent = "#ctaForm##ctaList#" />
