...
<cfset myFusebox.thisFuseaction = "villaDetails">
<cfset xfa.saveVillaDetails = "home.villaDetails" />
<cfif isDefined('attributes.save')>
<cfset application.villaObj.villaDetailsSave(argumentCollection=attributes) >
</cfif>
<cfset qVillaDetails = application.villaObj.getVillaDetails() >
<cfif qVillaDetails.recordCount gte 1>
<cfset attributes.vil_title = "#qVillaDetails.vil_title#" />
<cfset attributes.vil_description = "#qVillaDetails.vil_description#" />
<cfset attributes.vil_address = "#qVillaDetails.vil_address#" />
<cfset attributes.vil_phone = "#qVillaDetails.vil_phone#" />
<cfset attributes.vil_email = "#qVillaDetails.vil_email#" />
<cfset attributes.vil_otherContact = "#qVillaDetails.vil_otherContact#" />
<cfset attributes.vil_fax = "#qVillaDetails.vil_fax#" />
<cfelse>
<cfset attributes.vil_title = "" />
<cfset attributes.vil_description = "" />
<cfset attributes.vil_address = "" />
<cfset attributes.vil_phone = "" />
<cfset attributes.vil_email = "" />
<cfset attributes.vil_otherContact = "" />
<cfset attributes.vil_fax = "" />
</cfif>
<!--- do action="v_home.villaDetailsForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_home.villaDetailsForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_home">
<cfset myFusebox.thisFuseaction = "villaDetailsForm">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_villaDetailsForm.cfm"" circuit=""v_home""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../home/view/dsp_villaDetailsForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 24 and right(cfcatch.MissingFileName,24) is "dsp_villaDetailsForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_villaDetailsForm.cfm in circuit v_home which does not exist (from fuseaction v_home.villaDetailsForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
