...
<cfset myFusebox.thisFuseaction = "menuSectionList">
<cfset xfa.saveMenuSection = "system.menuSectionList" />
<cfset xfa.editMenuSection = "system.menuSectionList" />
<cfif not isDefined("attributes.mse_id")><cfset attributes.mse_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<!--- do action="m_system.menuSectionAction" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.menuSectionAction""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "menuSectionAction">
<cfset myFusebox.trace("Runtime","&lt;include template=""act_menuSectionAction.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/act_menuSectionAction.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 25 and right(cfcatch.MissingFileName,25) is "act_menuSectionAction.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_menuSectionAction.cfm in circuit m_system which does not exist (from fuseaction m_system.menuSectionAction).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "system">
<cfset myFusebox.thisFuseaction = "menuSectionList">
</cfif>
<!--- do action="m_system.getMenuSection" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.getMenuSection""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "getMenuSection">
<cfset myFusebox.trace("Runtime","&lt;include template=""qry_getMenuSection.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/qry_getMenuSection.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 22 and right(cfcatch.MissingFileName,22) is "qry_getMenuSection.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getMenuSection.cfm in circuit m_system which does not exist (from fuseaction m_system.getMenuSection).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "system">
<cfset myFusebox.thisFuseaction = "menuSectionList">
<cfif getMenuSection.recordCount gte 1>
<cfset attributes.mse_title = "#getMenuSection.mse_title#" />
<cfset attributes.mse_order = "#getMenuSection.mse_order#" />
<cfelse>
<cfset attributes.mse_title = "" />
<cfset attributes.mse_order = "0" />
</cfif>
<!--- do action="v_system.menuSectionForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_system.menuSectionForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_system">
<cfset myFusebox.thisFuseaction = "menuSectionForm">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_menuSectionForm.cfm"" circuit=""v_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/view/dsp_menuSectionForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "dsp_menuSectionForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_menuSectionForm.cfm in circuit v_system which does not exist (from fuseaction v_system.menuSectionForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
...
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="v_system.menuSectionList" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_system.menuSectionList""/&gt;") >
<cfset myFusebox.thisCircuit = "v_system">
<cfset myFusebox.thisFuseaction = "menuSectionList">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_menuSectionList.cfm"" circuit=""v_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/view/dsp_menuSectionList.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "dsp_menuSectionList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_menuSectionList.cfm in circuit v_system which does not exist (from fuseaction v_system.menuSectionList).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
