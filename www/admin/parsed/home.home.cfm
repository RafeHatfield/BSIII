...
<cfset attributes.displayMode = "Nav" />
<cfset request.pageTitle = "Home" />
<!--- do action="v_home.home" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_home.home""/&gt;") >
<cfset myFusebox.thisCircuit = "v_home">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_home.cfm"" circuit=""v_home""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../home/view/dsp_home.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 12 and right(cfcatch.MissingFileName,12) is "dsp_home.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_home.cfm in circuit v_home which does not exist (from fuseaction v_home.home).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
