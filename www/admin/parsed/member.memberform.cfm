...
<cfif not isDefined("attributes.groupOther")><cfset attributes.groupOther = "" /></cfif>
<cfif isDefined('attributes.save')>
<cfset attributes.mem_id = application.memberObj.memberSave(argumentCollection=attributes) >
<cfset application.memberObj.memberGroupSave(mem_id=attributes.mem_id, grp_id=attributes.grp_id, groupOther=attributes.groupOther) >
</cfif>
<cfset displayMemberFormOutput = application.memberObj.displayMemberForm(mem_id=attributes.mem_id) >
<cfset content.mainContent = "#displayMemberFormOutput#" />
