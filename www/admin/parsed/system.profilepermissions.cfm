...
<cfset myFusebox.thisFuseaction = "profilePermissions">
<cfset xfa.saveProfilePermissions = "system.profilePermissions" />
<cfif not isDefined("attributes.prf_id")><cfset attributes.prf_id = "0" /></cfif>
<cfif not isDefined("attributes.profilePermissionsList")><cfset attributes.profilePermissionsList = "" /></cfif>
<cfif isDefined('attributes.save')>
<!--- do action="m_system.profilePermissionsUpdate" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.profilePermissionsUpdate""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "profilePermissionsUpdate">
<cfset myFusebox.trace("Runtime","&lt;include template=""act_profilePermissionsUpdate.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/act_profilePermissionsUpdate.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 32 and right(cfcatch.MissingFileName,32) is "act_profilePermissionsUpdate.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_profilePermissionsUpdate.cfm in circuit m_system which does not exist (from fuseaction m_system.profilePermissionsUpdate).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "system">
<cfset myFusebox.thisFuseaction = "profilePermissions">
</cfif>
...
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.getProfilePermissions""/&gt;") >
<cfset myFusebox.thisFuseaction = "getProfilePermissions">
<cfset myFusebox.trace("Runtime","&lt;include template=""qry_getProfilePermissions.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/qry_getProfilePermissions.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 29 and right(cfcatch.MissingFileName,29) is "qry_getProfilePermissions.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getProfilePermissions.cfm in circuit m_system which does not exist (from fuseaction m_system.getProfilePermissions).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "system">
<cfset myFusebox.thisFuseaction = "profilePermissions">
<cfset attributes.thisProfilePermissionsList = "#valueList(getProfilePermissions.pff_processFuse)#" />
<!--- do action="v_system.profilePermissionsList" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_system.profilePermissionsList""/&gt;") >
<cfset myFusebox.thisCircuit = "v_system">
<cfset myFusebox.thisFuseaction = "profilePermissionsList">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_profilePermissionsList.cfm"" circuit=""v_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/view/dsp_profilePermissionsList.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 30 and right(cfcatch.MissingFileName,30) is "dsp_profilePermissionsList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_profilePermissionsList.cfm in circuit v_system which does not exist (from fuseaction v_system.profilePermissionsList).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
