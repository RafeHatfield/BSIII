...
<cfset myFusebox.thisFuseaction = "villaSales">
<cfif not isDefined("attributes.pro_id")><cfset attributes.pro_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.villaObj.propertySave(argumentCollection=attributes) >
</cfif>
<cfset propertyForm = application.villaObj.displayPropertyForm(pro_id=attributes.pro_id) >
<cfset propertyList = application.villaObj.adminPropertyList() >
<cfif not isDefined("content.mainContent")><cfset content.mainContent = "#propertyForm##propertyList#" /></cfif>
