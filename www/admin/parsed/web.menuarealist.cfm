...
<cfset myFusebox.thisFuseaction = "menuAreaList">
<cfset xfa.saveMenuArea = "web.menuAreaList" />
<cfset xfa.editMenuArea = "web.menuAreaList" />
<cfif not isDefined("attributes.mna_id")><cfset attributes.mna_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.menuObj.menuAreaSave(argumentCollection=attributes) >
</cfif>
<cfset qMenuArea = application.menuObj.getMenuArea(attributes.mna_id) >
<cfif qMenuArea.recordCount gte 1>
<cfset attributes.mna_title = "#qMenuArea.mna_title#" />
<cfset attributes.mna_active = "#qMenuArea.mna_active#" />
<cfelse>
<cfset attributes.mna_title = "" />
<cfset attributes.mna_active = "0" />
</cfif>
<!--- do action="v_web.menuAreaForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_web.menuAreaForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_web">
<cfset myFusebox.thisFuseaction = "menuAreaForm">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_menuAreaForm.cfm"" circuit=""v_web""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../web/view/dsp_menuAreaForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "dsp_menuAreaForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_menuAreaForm.cfm in circuit v_web which does not exist (from fuseaction v_web.menuAreaForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<cfset myFusebox.thisCircuit = "web">
<cfset myFusebox.thisFuseaction = "menuAreaList">
<cfset qMenuAreas = application.menuObj.getMenuAreas() >
<!--- do action="v_web.menuAreaList" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_web.menuAreaList""/&gt;") >
<cfset myFusebox.thisCircuit = "v_web">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_menuAreaList.cfm"" circuit=""v_web""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../web/view/dsp_menuAreaList.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "dsp_menuAreaList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_menuAreaList.cfm in circuit v_web which does not exist (from fuseaction v_web.menuAreaList).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
