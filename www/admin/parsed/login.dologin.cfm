...
<cfset myFusebox.trace("Runtime","&lt;do action=""m_login.checkUser""/&gt;") >
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisFuseaction = "checkUser">
<cfset myFusebox.trace("Runtime","&lt;include template=""qry_checkUser.cfm"" circuit=""m_login""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../login/model/qry_checkUser.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 17 and right(cfcatch.MissingFileName,17) is "qry_checkUser.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_checkUser.cfm in circuit m_login which does not exist (from fuseaction m_login.checkUser).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "login">
<cfset myFusebox.thisFuseaction = "doLogin">
<cfif checkUser.recordcount is 1>
<!--- do action="m_login.setLoginDetails" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_login.setLoginDetails""/&gt;") >
<cfset myFusebox.thisCircuit = "m_login">
<cfset myFusebox.thisFuseaction = "setLoginDetails">
<cfset myFusebox.trace("Runtime","&lt;include template=""act_setLoginDetails.cfm"" circuit=""m_login""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../login/model/act_setLoginDetails.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "act_setLoginDetails.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_setLoginDetails.cfm in circuit m_login which does not exist (from fuseaction m_login.setLoginDetails).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "login">
<cfset myFusebox.thisFuseaction = "doLogin">
<cflocation url="#myself#home.home" addtoken="false">
<cfabort>
<cfelse>
<cfset message = "Incorrect Username or Password." />
<cflocation url="#myself#login.form&message=#message#" addtoken="false">
<cfabort>
</cfif>
