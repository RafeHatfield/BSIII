...
<cfset xfa.editMember = "member.memberForm" />
<cfset xfa.memberMessages = "member.memberMessages" />
...
<cfif not isDefined("attributes.country")><cfset attributes.country = "0" /></cfif>
<cfset content.mainContent = application.memberObj.displayMemberSearch(argumentCollection=attributes) >
<cfset qMembers = application.memberObj.getMembers(argumentCollection=attributes) >
<!--- do action="v_member.memberList" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_member.memberList""/&gt;") >
<cfset myFusebox.thisCircuit = "v_member">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_memberList.cfm"" circuit=""v_member""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../member/view/dsp_memberList.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_memberList.cfm in circuit v_member which does not exist (from fuseaction v_member.memberList).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
