...
<cfset myFusebox.thisFuseaction = "gloryMessage">
<cfif isDefined('attributes.save')>
<cfset application.contentObj.gloryMessageSave(argumentCollection=attributes) >
</cfif>
<cfset content.mainContent = application.contentObj.displayGloryMessageForm() >
