...
<cfset application.imageObj.gallerySave(argumentCollection=attributes) >
</cfif>
<cfset galleryForm = application.imageObj.displayGalleryForm(gal_id=attributes.gal_id) >
<cfset galleryList = application.imageObj.adminGalleryList() >
<cfset content.mainContent = "#galleryForm##galleryList#" />
