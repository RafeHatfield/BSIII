...
<cfset myFusebox.thisFuseaction = "newsletterForm">
<cfset xfa.saveNewsletter = "member.newsletterForm" />
<cfif not isDefined("attributes.nsl_id")><cfset attributes.nsl_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset attributes.nsl_id = application.contentObj.newsletterSave(argumentCollection=attributes) >
</cfif>
<cfset qNewsletter = application.contentObj.getNewsletter(nsl_id=attributes.nsl_id) >
<cfset qNewsletterContent = application.contentObj.getNewsletterContent(nsl_id=attributes.nsl_id) >
<cfset qAllContent = application.contentObj.getAllContent(approved=1,con_type='Content,Newsletter',excludeContent=valueList(qNewsletterContent.con_id)) >
<cfif qNewsletter.recordCount>
<cfset attributes.nsl_title = "#qNewsletter.nsl_title#" />
<cfset attributes.nsl_body = "#qNewsletter.nsl_body#" />
<cfelse>
<cfset attributes.nsl_title = "" />
<cfset attributes.nsl_body = "" />
</cfif>
<!--- do action="v_member.newsletterForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_member.newsletterForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_member">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_newsletterForm.cfm"" circuit=""v_member""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../member/view/dsp_newsletterForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 22 and right(cfcatch.MissingFileName,22) is "dsp_newsletterForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_newsletterForm.cfm in circuit v_member which does not exist (from fuseaction v_member.newsletterForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
