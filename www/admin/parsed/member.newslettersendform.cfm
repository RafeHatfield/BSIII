...
<cfset myFusebox.thisFuseaction = "newsletterSendForm">
<cfset xfa.sendNewsletter = "member.newsletterSendForm" />
<cfif not isDefined("attributes.nsl_id")><cfset attributes.nsl_id = "0" /></cfif>
<cfif not isDefined("attributes.grp_id")><cfset attributes.grp_id = "" /></cfif>
<cfif not isDefined("attributes.cou_id")><cfset attributes.cou_id = "" /></cfif>
<cfif not isDefined("attributes.int_id")><cfset attributes.int_id = "" /></cfif>
<cfif not isDefined("attributes.newslettersSent")><cfset attributes.newslettersSent = "0" /></cfif>
<cfif isDefined('attributes.send')>
<cfset attributes.newslettersSent = application.contentObj.newsletterSend(argumentCollection = attributes) >
</cfif>
<cfset qNewsletter = application.contentObj.getNewsletter(nsl_id=attributes.nsl_id) >
<cfset qGroups = application.memberObj.getGroups() >
<cfset qCountries = application.memberObj.getCountries() >
<cfset qInterests = application.memberObj.getInterests() >
<cfset qMemberNewsletter = application.memberObj.getMemberNewsletter(nsl_id=attributes.nsl_id) >
<!--- do action="v_member.newsletterSendForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_member.newsletterSendForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_member">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_newsletterSendForm.cfm"" circuit=""v_member""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../member/view/dsp_newsletterSendForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 26 and right(cfcatch.MissingFileName,26) is "dsp_newsletterSendForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_newsletterSendForm.cfm in circuit v_member which does not exist (from fuseaction v_member.newsletterSendForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<!--- do action="v_member.memberNewsletterList" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_member.memberNewsletterList""/&gt;") >
<cfset myFusebox.thisFuseaction = "memberNewsletterList">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_memberNewsletterList.cfm"" circuit=""v_member""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../member/view/dsp_memberNewsletterList.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 28 and right(cfcatch.MissingFileName,28) is "dsp_memberNewsletterList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_memberNewsletterList.cfm in circuit v_member which does not exist (from fuseaction v_member.memberNewsletterList).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
