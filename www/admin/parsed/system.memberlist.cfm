...
<cfset myFusebox.thisFuseaction = "memberList">
<cfset xfa.searchMember = "system.memberList" />
<cfset xfa.editMember = "system.memberForm" />
<cfset xfa.memberPermissions = "system.memberPermissions" />
<cfset xfa.memberProfile = "system.memberProfile" />
...
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="v_system.memberSearch" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_system.memberSearch""/&gt;") >
<cfset myFusebox.thisCircuit = "v_system">
<cfset myFusebox.thisFuseaction = "memberSearch">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_memberSearch.cfm"" circuit=""v_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/view/dsp_memberSearch.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "dsp_memberSearch.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_memberSearch.cfm in circuit v_system which does not exist (from fuseaction v_system.memberSearch).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<!--- do action="m_system.getMembers" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.getMembers""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "getMembers">
<cfset myFusebox.trace("Runtime","&lt;include template=""qry_getMembers.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/qry_getMembers.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 18 and right(cfcatch.MissingFileName,18) is "qry_getMembers.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getMembers.cfm in circuit m_system which does not exist (from fuseaction m_system.getMembers).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="v_system.memberList" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_system.memberList""/&gt;") >
<cfset myFusebox.thisCircuit = "v_system">
<cfset myFusebox.thisFuseaction = "memberList">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_memberList.cfm"" circuit=""v_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/view/dsp_memberList.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 18 and right(cfcatch.MissingFileName,18) is "dsp_memberList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_memberList.cfm in circuit v_system which does not exist (from fuseaction v_system.memberList).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
