...
<cfset myFusebox.thisFuseaction = "memberForm">
<cfset xfa.saveMember = "system.memberForm" />
<cfset xfa.changePassword = "system.passwordForm" />
<cfif not isDefined("attributes.usr_id")><cfset attributes.usr_id = "0" /></cfif>
...
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.memberAction""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "memberAction">
<cfset myFusebox.trace("Runtime","&lt;include template=""act_memberAction.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/act_memberAction.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "act_memberAction.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_memberAction.cfm in circuit m_system which does not exist (from fuseaction m_system.memberAction).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cfset myFusebox.thisCircuit = "system">
<cfset myFusebox.thisFuseaction = "memberForm">
<cflocation url="#myself#system.memberList" addtoken="false">
<cfabort>
</cfif>
<!--- do action="m_system.getMember" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""m_system.getMember""/&gt;") >
<cfset myFusebox.thisCircuit = "m_system">
<cfset myFusebox.thisFuseaction = "getMember">
<cfset myFusebox.trace("Runtime","&lt;include template=""qry_getMember.cfm"" circuit=""m_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/model/qry_getMember.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 17 and right(cfcatch.MissingFileName,17) is "qry_getMember.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getMember.cfm in circuit m_system which does not exist (from fuseaction m_system.getMember).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
...
<cfset myFusebox.thisCircuit = "system">
<cfset myFusebox.thisFuseaction = "memberForm">
<cfif getMember.recordCount gte 1>
<cfset attributes.usr_firstName = "#getMember.usr_firstName#" />
<cfset attributes.usr_surname = "#getMember.usr_surname#" />
<cfset attributes.usr_email = "#getMember.usr_email#" />
<cfset attributes.usr_password = "#getMember.usr_password#" />
<cfset attributes.prf_id = "#getMember.usr_profile#" />
<cfelse>
<cfif not isDefined("attributes.usr_firstName")><cfset attributes.usr_firstName = "" /></cfif>
<cfif not isDefined("attributes.usr_surname")><cfset attributes.usr_surname = "" /></cfif>
<cfif not isDefined("attributes.usr_email")><cfset attributes.usr_email = "" /></cfif>
<cfif not isDefined("attributes.usr_password")><cfset attributes.usr_password = "" /></cfif>
<cfset attributes.prf_id = "0" />
</cfif>
<!--- do action="v_system.memberForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_system.memberForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_system">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_memberForm.cfm"" circuit=""v_system""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../system/view/dsp_memberForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 18 and right(cfcatch.MissingFileName,18) is "dsp_memberForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_memberForm.cfm in circuit v_system which does not exist (from fuseaction v_system.memberForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
