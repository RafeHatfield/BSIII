...
border-color:black; --->
		<div id="container">
		    ...
		    <div class="content">
		        ...
		        <div class="maincontent" style="width:838px">
		        
		        	<div class="maincontent_inner">
		        	
		        		<div class="maincontent_list_box" style="width:644px">
			            	#trim(content.gloryBox)#
			            </div>

		                <div class="reservations_box" style="padding-left:0px;border-width:0px">
		                    #trim(application.reservationObj.displayReservationForm())#
		                    <br />
		                    <img src="assets/images/cta2.jpg" width="185" /><br /><br />
		                    <img src="assets/images/cta1.jpg" width="185" />
