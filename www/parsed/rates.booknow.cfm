...
<cfset myFusebox.thisFuseaction = "bookNow">
...
<cfif not isDefined("attributes.beds")><cfset attributes.beds = "1" /></cfif>
<cfif not isDefined("attributes.contactSuccess")><cfset attributes.contactSuccess = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset attributes.contactSuccess = application.villaObj.bookNowFormSave(argumentCollection=attributes) >
</cfif>
...
<cfset myFusebox.thisCircuit = "rates">
<cfset myFusebox.thisFuseaction = "bookNow">
<cfset bookNowForm = application.villaObj.displayBookNowForm(beds=attributes.beds,contactSuccess=attributes.contactSuccess) >
<cfset content.mainContent = "#content.mainContent##bookNowForm#" />
