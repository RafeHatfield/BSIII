...
<!--- circuit: rates --->
<!--- fuseaction: promotionView --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "rates">
<cfset myFusebox.thisFuseaction = "promotionView">
...
<cfif not isDefined("attributes.contactSuccess")><cfset attributes.contactSuccess = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset attributes.contactSuccess = application.villaObj.promotionContactSave(argumentCollection=attributes) >
</cfif>
<cfset content.mainContent = application.villaObj.displayPromotion(prm_id=attributes.prm_id,contactSuccess=attributes.contactSuccess) >
<cfset content.gloryBox = application.villaObj.displayPromotionGloryBox(prm_id=attributes.prm_id) >
