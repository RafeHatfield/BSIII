...
<cfset myFusebox.thisCircuit = "news">
...
<cfset attributes.newsletterSuccess = application.newsObj.newsletterFormSave(argumentCollection=attributes) >
</cfif>
<cfif not isDefined("attributes.newsletterSuccess")><cfset attributes.newsletterSuccess = "0" /></cfif>
<cfset attributes.newsletterFormOutput = application.newsObj.displayNewsletterForm(newsletterSuccess=attributes.newsletterSuccess) >
<cfset content.mainContent = "#attributes.newsletterFormOutput#" />
