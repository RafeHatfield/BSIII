...
<!--- circuit: rates --->
<!--- fuseaction: promotions --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "rates">
<cfset myFusebox.thisFuseaction = "promotions">
...
<cfset myFusebox.thisCircuit = "rates">
<cfset myFusebox.thisFuseaction = "promotions">
<cfset promotionsList = application.villaObj.displayPromotions() >
<cfset content.mainContent = "#content.mainContent##promotionsList#" />
