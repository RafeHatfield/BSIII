...
<!--- circuit: contact --->
<!--- fuseaction: contactDetails --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "contact">
<cfset myFusebox.thisFuseaction = "contactDetails">
...
<cfset attributes.VillaAddress = application.villaObj.displayVillaAddress(attributes.feedbackFormSuccess) >
<cfset attributes.feedbackForm = application.contactObj.displayFeedbackForm(attributes.feedbackFormSuccess) >
<cfset content.mainContent = "#attributes.VillaAddress##attributes.feedbackForm#" />
