...
<cfset myFusebox.thisCircuit = "facilities">
<cfset myFusebox.thisFuseaction = "events">
...
<cfset attributes.facilitiesFormSuccess = application.contactObj.facilitiesFormSave(argumentCollection=attributes) >
</cfif>
<cfif not isDefined("attributes.facilitiesFormSuccess")><cfset attributes.facilitiesFormSuccess = "0" /></cfif>
<cfset attributes.displayContentOutput = application.contentObj.displayContent(fuseAction=attributes.fuseAction) >
<cfset content.mainContent = "#attributes.displayContentOutput#" />
