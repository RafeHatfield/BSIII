...
<!--- circuit: contact --->
<!--- fuseaction: feedbackForm --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "contact">
<cfset myFusebox.thisFuseaction = "feedbackForm">
...
<cfset attributes.displayContentOutput = "" />
<cfelse>
<cfset attributes.displayContentOutput = application.contentObj.displayContent(fuseAction=attributes.fuseAction) >
</cfif>
<cfif not isDefined("attributes.feedbackFormSuccess")><cfset attributes.feedbackFormSuccess = "0" /></cfif>
<cfset attributes.displayFeedbackFormOutput = application.contactObj.displayFeedbackForm(feedbackSuccess=attributes.feedbackFormSuccess) >
<cfset content.mainContent = "#attributes.displayContentOutput##attributes.displayFeedbackFormOutput#" />
