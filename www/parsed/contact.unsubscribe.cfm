...
<!--- circuit: contact --->
<!--- fuseaction: unsubscribe --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "contact">
<cfset myFusebox.thisFuseaction = "unsubscribe">
...
<cfset unsubscribeStatus = application.contactObj.unsubscribe(#attributes.email#) >
<cfelse>
<cfset unsubscribeStatus = "0" />
</cfif>
<cfset content.mainContent = application.contactObj.unsubscribeForm(unsubscribeStatus=#unsubscribeStatus#) >
